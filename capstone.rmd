...
print("Top 15 most important features based on Random Forest importance:")
print(head(importance_df, 15))

potentially_leaky_features_rf <- names(head(sort(initial_model$variable.importance, decreasing = TRUE), 5))
